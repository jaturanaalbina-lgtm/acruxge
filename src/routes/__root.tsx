  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Verifique o endereço ou volte ao painel.</p>
        <div className="mt-6">
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex justify-center gap-2">
          <button onClick={() => { router.invalidate(); reset(); }} className="rounded-md bg-primary px-4 py-2 text-sm text-primary-foreground">Tentar novamente</button>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GE by Acrux ROBOCEP — Gestão de Equipe" },
      { name: "description", content: "GE by Acrux ROBOCEP: gestão de projetos, tarefas, ponto e conteúdo para equipes de robótica." },
      { property: "og:title", content: "GE by Acrux ROBOCEP — Gestão de Equipe" },
      { property: "og:description", content: "GE by Acrux ROBOCEP: gestão de projetos, tarefas, ponto e conteúdo para equipes de robótica." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "GE by Acrux ROBOCEP — Gestão de Equipe" },
      { name: "twitter:description", content: "GE by Acrux ROBOCEP: gestão de projetos, tarefas, ponto e conteúdo para equipes de robótica." },
